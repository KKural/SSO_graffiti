...
df_sso_data <- read.csv(here::here("./20240919_sso_data_anon.csv"))
...
sf_ghent_street_segments <- sf::st_read(dsn = here::here("sf_ghent_street_segments.shp"))
...
sf_large_file <- sf::st_read(dsn = here::here("sf_large_file_new_combined.shp")) |>
...
# Network analysis--------------------------------------------------------------
adj_file <- here::here("./extened_adjacent_within5m.rds") 
...
write.csv(df_basic_summary, "./20240101_ann_output_sso/basic_summary.csv", row.names = FALSE)
# Summary statistics------------------------------------------------------------
...
write.csv(table_1, "20240101_ann_output_sso/table_1.csv", row.names = FALSE)
